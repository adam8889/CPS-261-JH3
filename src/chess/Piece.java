...
class ChessPiece
{
    ...
    {
    	//didn't like having a huge list of .gifs in the parent directory, so I put them in a folder
    	//and changed the code a bit to load in from that folder instead.
        String imageName ="pieces" + File.separator + colorType[colorIndex].toString() +
